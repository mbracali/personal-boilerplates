...
Designs and maintains the pipelines that collect, process, and store data.
Ensures clean and reliable data is always available.
"""
...
project_tech_analyst_data_eng = Agent(
